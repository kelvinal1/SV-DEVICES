...
public class Ventana_Fabricantes extends javax.swing.JInternalFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Fabricantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Fabricantes().setVisible(true);
            }
        });
    }
